    ...
    object Grid3View: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn16
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn15
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn14
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn13
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn12
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn11
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn10
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn1
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = Grid3ViewColumn7
        end>
      ...
      object Grid3ViewColumn6: TcxGridDBColumn
        DataBinding.FieldName = #48156#51452#49324#53076#46300
        PropertiesClassName = 'TcxLabelProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
        FooterAlignmentHorz = taRightJustify
      ...
      object Grid3ViewColumn2: TcxGridDBColumn
        DataBinding.FieldName = #49688#51452#49324#53076#46300
        PropertiesClassName = 'TcxLabelProperties'
        Properties.Alignment.Vert = taVCenter
        FooterAlignmentHorz = taRightJustify
        HeaderAlignmentHorz = taCenter
      ...
      object Grid3ViewColumn3: TcxGridDBColumn
        DataBinding.FieldName = #49688#51452#49324
        PropertiesClassName = 'TcxLabelProperties'
        FooterAlignmentHorz = taRightJustify
        HeaderAlignmentHorz = taCenter
        Width = 102
      ...
      object Grid3ViewColumn1: TcxGridDBColumn
        DataBinding.FieldName = #50868#54665#49688#49688#47308
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0;-,0'
        FooterAlignmentHorz = taRightJustify
