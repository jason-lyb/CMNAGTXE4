...
procedure TFrm_SETA1N.changeTRSPenaltyType1(Sender: TObject);
begin
  CheckTRSPenaltyChange(1, GS_TRS_PENALTY.Type1);
end;

procedure TFrm_SETA1N.changeTRSPenaltyType2(Sender: TObject);
begin
  CheckTRSPenaltyChange(2, GS_TRS_PENALTY.Type2);
end;

procedure TFrm_SETA1N.btn215SaveClick(Sender: TObject);
Var i : Integer;
    isRun : Boolean;
begin
  isRun := False;
...
procedure TFrm_SETA1N.pSetJON01TabSelectView;
begin
...
procedure TFrm_SETA1N.btn3Click(Sender: TObject);
begin
  Try
...
procedure TFrm_SETA1N.btn4Click(Sender: TObject);
var
  sQuery, sDate: string;
begin
...
procedure TFrm_SETA1N.btn5Click(Sender: TObject);
begin
  Edt_PW.Text := '';
  Edt_PPw.Text := '';
  Edt_APw.Text := '';
...
procedure TFrm_SETA1N.btn6Click(Sender: TObject);
begin
  Pnl_LocalData.Height := 245;
  Edt_PPw.SetFocus;
end;

procedure TFrm_SETA1N.btnAddRingClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.btnAll1Click(Sender: TObject);
var
  sQuery: string;
begin
...
procedure TFrm_SETA1N.btnAll2Click(Sender: TObject);
begin
  Pnl_LocalData.Height := 114;
end;

procedure TFrm_SETA1N.BtnCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TFrm_SETA1N.btnFSizeSClick(Sender: TObject);
...
procedure TFrm_SETA1N.btnModeSaveClick(Sender: TObject);
Var sMsg : String;
    hProc : THandle;
    seFile: TIniFile;
begin
...
procedure TFrm_SETA1N.btnNmlAcceptReloadClick(Sender: TObject);
begin
  SetAcceptTitle;
end;

procedure TFrm_SETA1N.btnNmlAcceptResetClick(Sender: TObject);
var
  ln_envfile: TIniFile;
begin
...
procedure TFrm_SETA1N.btnNmlTRSType2SaveClick(Sender: TObject);
begin
  // 페널티 명
...
procedure TFrm_SETA1N.btnOrderBellSetClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.btnOrderCancelReason0Click(Sender: TObject);
var
  i: Integer;
begin
...
procedure TFrm_SETA1N.btnSaveClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.BtnSearchClick(Sender: TObject);
Var
  i, iRow: Integer;
...
procedure TFrm_SETA1N.btnUpClick(Sender: TObject);
...
procedure TFrm_SETA1N.btn_AllPopUpPositionClick(Sender: TObject);
begin
	gPositionClear := True;
...
procedure TFrm_SETA1N.btn_BubHuListSaveClick(Sender: TObject);
var
	i : Integer;
begin
	SetDebugeWrite('TFrm_SETA1N.btn_BubHuListSaveClick');
	Try
...
procedure TFrm_SETA1N.btn_ConnectTestClick(Sender: TObject);
Var i : Integer;
begin
...
procedure TFrm_SETA1N.btn_msg_closeClick(Sender: TObject);
var sTmp : string;
	iTmp : integer;
begin
...
procedure TFrm_SETA1N.btn_StatDnClick(Sender: TObject);
var
	CurIndex: Integer;
begin
...
procedure TFrm_SETA1N.btn_StatSaveClick(Sender: TObject);
var
  i: Integer;
begin
...
procedure TFrm_SETA1N.btn_StatUpClick(Sender: TObject);
var
  CurIndex: Integer;
begin
  CurIndex := lb_stat.ItemIndex;
...
procedure TFrm_SETA1N.btn_wR1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.CbAcceptMemo1Click(Sender: TObject);
begin
  gJONAcceptMemo.Use := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('AcceptMemo', 'Use', gJONAcceptMemo.Use);
end;

procedure TFrm_SETA1N.cbbOrderTime1PropertiesChange(Sender: TObject);
var
	Sec: string;
	Time: Integer;
begin
...
procedure TFrm_SETA1N.cbb_AfterMoneyClick(Sender: TObject);
begin
  // 2011.03.02 후불기본값
...
procedure TFrm_SETA1N.cbDriverChargeLocalValuePropertiesChange(Sender: TObject);
begin
  try
...
procedure TFrm_SETA1N.cbMyMainRateNoChangeClick(Sender: TObject);
begin
	gsMyMainRateNoChange := TcxCheckBox(Sender).Checked;
	GS_EnvFile.WriteBool('MYMAINTELUSE', 'RateNoChange', gsMyMainRateNoChange);
end;

procedure TFrm_SETA1N.cb_DurationPropertiesChange(Sender: TObject);
var iTime: Integer;
begin
...
procedure TFrm_SETA1N.chkCardBigoUseClick(Sender: TObject);
begin
  gsJON01CardBigoUse := chkCardBigoUse.Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'gsJON01CardBigoUse', gsJON01CardBigoUse);
end;

procedure TFrm_SETA1N.chkChangeOrderScrollTopClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkFileCallingUseClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkJon012DestSearchUSEClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkJon01ShortMenuClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkJON01_UPMODE2Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkJON01_UPMODE3Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkJONAreaAutoSETClick(Sender: TObject);
begin
	GS_AREA_AUTO_SET := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'GS_AREA_AUTO_SET', GS_AREA_AUTO_SET);
end;

procedure TFrm_SETA1N.chkJONAreaAutoShowClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkNmlInputAutoCloseClick(Sender: TObject);
begin
  GS_WKCASH_AUTOCLOSE := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('WKCASH_DEFAULT', 'FINISH_AUTOCLOSE', GS_WKCASH_AUTOCLOSE);
end;

procedure TFrm_SETA1N.chkNmlInputFixedAccTabClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkNmlInputNoMsgClick(Sender: TObject);
begin
  GS_WKCASH_NOMSG := TcxCheckBox(Sender).Checked;
	GS_EnvFile.WriteBool('WKCASH_DEFAULT', 'FINISH_NOMSG', GS_WKCASH_NOMSG);
end;

procedure TFrm_SETA1N.chkNmlReadyNoShowWinClick(Sender: TObject);
begin
  GB_JONLIST_READY_NOSHOW := chkNmlReadyNoShowWin.Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'ReadyNoShow', GB_JONLIST_READY_NOSHOW);
end;

procedure TFrm_SETA1N.chkNmlRetryNoShowWinClick(Sender: TObject);
begin
  GB_JONLIST_RETRY_NOSHOW := chkNmlRetryNoShowWin.Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'RetryNoShow', GB_JONLIST_RETRY_NOSHOW);
end;

procedure TFrm_SETA1N.chkNmlTRSType1StepUse1Click(Sender: TObject);
begin
  CheckTRSPenaltyChange(1, GS_TRS_PENALTY.Type1);
end;

procedure TFrm_SETA1N.chkNmlTRSType2StepUse1Click(Sender: TObject);
begin
  CheckTRSPenaltyChange(2, GS_TRS_PENALTY.Type2);
end;

procedure TFrm_SETA1N.chkNmlTRSType2Unlock1Click(Sender: TObject);
begin
  CheckTRSPenaltyChange(2, GS_TRS_PENALTY.Type2);
end;

procedure TFrm_SETA1N.chkNmlXlsAutoOpenClick(Sender: TObject);
begin
  GS_XLS_AUTOOPEN := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('GER', 'XlsAutoOpen', GS_XLS_AUTOOPEN);
end;

procedure TFrm_SETA1N.chkNmlXlsDTypeUseClick(Sender: TObject);
begin
  GS_XLS_DTypeUse := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('GER', 'XlsDTypeUse', GS_XLS_DTypeUse);
end;

procedure TFrm_SETA1N.chkOrderBellUsePropertiesChange(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cbOrderBellTimePropertiesChange(Sender: TObject);
var
	Sec: string;
	iTime: Integer;
begin
...
procedure TFrm_SETA1N.chkOrderColorClick(Sender: TObject);
begin
	gJONOrderColor.Use := TcxCheckBox(Sender).Checked;
	GS_EnvFile.WriteBool('OrderColor', 'Use', gJONOrderColor.Use);
end;

procedure TFrm_SETA1N.chkOrderUse1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkPostBigoUseClick(Sender: TObject);
begin
  gsJON01PostBigoUse := chkPostBigoUse.Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'gsJON01PostBigoUse', gsJON01PostBigoUse);
end;

procedure TFrm_SETA1N.chkProgSizeClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chk_CallWorkerClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chk_COUNSEL_TITLE_VIEW1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chk_COUNSEL_TITLE_VIEW2Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chk_JON03DetailExcelViewClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chk_KMAiRateClick(Sender: TObject);
var sTmp : string;
begin
...
procedure TFrm_SETA1N.cbo_KMAiRatePropertiesChange(Sender: TObject);
var sTmp : string;
begin
...
procedure TFrm_SETA1N.chk_ShortCut_Space_NoUsePropertiesChange(Sender: TObject);
var i, iTmp : integer;
begin
...
procedure TFrm_SETA1N.chk_wk_tr_useClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxBRListSetColorCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
var
  Row, Col: Integer;
...
procedure TFrm_SETA1N.cxBRListSetColorCustomDrawCell
...
procedure TFrm_SETA1N.cxBtnAddrBSaveClick(Sender: TObject);
Var
  i, iCnt: Integer;
begin
...
procedure TFrm_SETA1N.cxBtnSchBSaveClick(Sender: TObject);
Var
  i, iCnt: Integer;
begin
...
procedure TFrm_SETA1N.cxButton13Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxButton14Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxButton1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.btnFastFindInitClick(Sender: TObject);
begin
  try
...
procedure TFrm_SETA1N.cxButton3Click(Sender: TObject);
var
  i: Integer;
begin
  try
...
procedure TFrm_SETA1N.btnCnClick(Sender: TObject);
begin
  pnlSvrOpt.Visible := False;
end;

procedure TFrm_SETA1N.btnConfigExitClick(Sender: TObject);
begin
  grpConfigSave.Visible := True;
end;

procedure TFrm_SETA1N.btnConfigSaveClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.btnDeleteClick(Sender: TObject);
Var slTmp : TStringList;
begin
  try
    slTmp := TStringList.Create;
...
procedure TFrm_SETA1N.btnDownClick(Sender: TObject);
Var slTmp : TStringList;
begin
  try
    slTmp := TStringList.Create;
...
procedure TFrm_SETA1N.btnFastFindInClick(Sender: TObject);
var
  CurIndex: Integer;
begin
...
procedure TFrm_SETA1N.btnFastFindOutClick(Sender: TObject);
var
  CurIndex: Integer;
begin
...
procedure TFrm_SETA1N.btnFastFindSaveClick(Sender: TObject);
var
  i : Integer;
begin
...
procedure TFrm_SETA1N.btnFontSaveClick(Sender: TObject);
Var i : Integer;
begin
...
procedure TFrm_SETA1N.cxButton59Click(Sender: TObject);
begin
  Proc_BRANCH_COLORList;
  proc_SetBRcolor;
end;

procedure TFrm_SETA1N.cxButton60Click(Sender: TObject);
var
  ErrCode: Integer;
...
procedure TFrm_SETA1N.cxButton6Click(Sender: TObject);
var
  i: Integer;
begin
  try
...
procedure TFrm_SETA1N.cxButton8Click(Sender: TObject);
begin
  gJONAcceptMemo.Memo := Ed_AcceptMemo1.Text;
  GS_EnvFile.WriteString('AcceptMemo', 'Memo', gJONAcceptMemo.Memo);
end;

procedure TFrm_SETA1N.cxButton9Click(Sender: TObject);
var
  CurIndex: Integer;
begin
...
procedure TFrm_SETA1N.cxCheckBox4Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.chkMileUnitUseClick(Sender: TObject);
begin
  gsJON01MileUnitUse := chkMileUnitUse.Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'gsJON01MileUnitUse', gsJON01MileUnitUse);
end;

procedure TFrm_SETA1N.chkMultiCallNumClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxChkAfterMoneyWordUse1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxChkAfterMoneyWordUseClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxChkCreditMoneyClick(Sender: TObject);
begin
  // 접수창에서 결제구분(현금,후불,외상) 사용여부 설정.
  // 추가 : 2008-10-10 choi do soon
  // 외상 사용여부 설정.
...
procedure TFrm_SETA1N.cxChkNoSMSConfirmClick(Sender: TObject);
begin
  GB_JON_NOSMSCONFIRM := TcxCheckBox(Sender).Checked;
  GS_EnvFile.WriteBool('COUNSEL', 'GB_JON_NOSMSCONFIRM', GB_JON_NOSMSCONFIRM);
end;

procedure TFrm_SETA1N.cxGridDBColumn6PropertiesChange(Sender: TObject);
var iRow : integer;
begin
...
procedure TFrm_SETA1N.cxGridSchViewCellDblClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
Var
  iRow, iTag: Integer;
...
procedure TFrm_SETA1N.cxGridSchViewKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrm_SETA1N.cxGroupBox59MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
  PostMessage(pnlSvrOpt.Handle, WM_SYSCOMMAND, $F012, 0);
end;

procedure TFrm_SETA1N.cxImage1Click(Sender: TObject);
begin
  cxRBJon01VTypeA.Checked := True;
end;

procedure TFrm_SETA1N.cxImage2Click(Sender: TObject);
begin
  cxRBJon01VTypeB.Checked := True;
end;

procedure TFrm_SETA1N.SetTreeSelItem(idx: Integer);
var
  i: Integer;
begin
...
procedure TFrm_SETA1N.cxLabel5Click(Sender: TObject);
var
  s: string;
  i: Integer;
begin
...
procedure TFrm_SETA1N.cxCheckBox2Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxRBViaStartClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxRadioButton16Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxRadioButton1Click(Sender: TObject);
var
  sTemp, sPath: string;
  bFileLoad: Boolean;
begin
...
procedure TFrm_SETA1N.cxRadioButton33Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbWORSOSOK_VIEW1Click(Sender: TObject);
begin
  GB_WORSOSOK_VIEW := TcxRadioButton(Sender).Tag = 1;
  GS_EnvFile.WriteBool('WORKER', 'GB_WORSOSOK_VIEW', GB_WORSOSOK_VIEW);
end;

procedure TFrm_SETA1N.cxRBJon01TypeAClick(Sender: TObject);
begin
  btn215Save.Tag := 1;
end;

procedure TFrm_SETA1N.cxRBJon01VTypeAClick(Sender: TObject);
begin
  btn215Save.Tag := 1;
end;

procedure TFrm_SETA1N.cxRadioButton5Click(Sender: TObject);
begin
  CHARGE_DIS := TcxRadioButton(Sender).Caption;
  GS_EnvFile.WriteString('CHARGE', 'dis_type', CHARGE_DIS);
end;

procedure TFrm_SETA1N.cxRadioButton7Click(Sender: TObject);
begin
  GT_SUM_DEFAULT := TcxRadioButton(Sender).Tag;
  GS_EnvFile.WriteString('WORKER', 'SUMDEF', IntToStr(GT_SUM_DEFAULT));
end;

procedure TFrm_SETA1N.cxRadioButton9Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxRdoAutoCloseClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxRdoAutoCloseNotClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.cxScrollBox1MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  ReleaseCapture;
...
procedure TFrm_SETA1N.edt_msg_closeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
	if Key = VK_Return then btn_msg_close.Click;
end;

procedure TFrm_SETA1N.edt_msg_closeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrm_SETA1N.cxTreeView1Click(Sender: TObject);
var
	i: Integer;
begin
...
procedure TFrm_SETA1N.cxTreeView1CustomDrawItem(Sender: TCustomTreeView;
  Node: TTreeNode; State: TCustomDrawState; var DefaultDraw: Boolean);
begin
...
procedure TFrm_SETA1N.edtNmlTRSType1Unlock1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key in ['0' .. '9', #13, #8, '-'] then
  else
...
procedure TFrm_SETA1N.edtNmlTRSType1Unlock1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  changeTRSPenaltyType1(Sender);
end;

procedure TFrm_SETA1N.edtNmlTRSType2NameKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  changeTRSPenaltyType2(Sender);
end;

procedure TFrm_SETA1N.edtNmlTRSType2Unlock1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key in ['0' .. '9', #13, #8, '-'] then
  else
...
procedure TFrm_SETA1N.edtNmlTRSType2Unlock1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  changeTRSPenaltyType2(Sender);
end;

procedure TFrm_SETA1N.EdtSearchKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrm_SETA1N.EdtSearchKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrm_SETA1N.Edt_BPwKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (ActiveControl <> nil) and (key = VK_RETURN) then btnAll1.SetFocus;
end;

procedure TFrm_SETA1N.Edt_PPwKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrm_SETA1N.Edt_PWKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (ActiveControl <> nil) and (key = VK_RETURN) then btn4.Click;
end;

procedure TFrm_SETA1N.ed_MaddBrchNameClick(Sender: TObject);
var
  i: Integer;
  ss_Value: string;
begin
...
procedure TFrm_SETA1N.ed_pwKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then
    RbButton19.Click;
...
procedure TFrm_SETA1N.FormActivate(Sender: TObject);
begin
	cxLblActive.Color := GS_ActiveColor;
  cxLblActive.Visible := True;
end;

procedure TFrm_SETA1N.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if GS_DefaultColor.Form <> '' then
  begin
    pFormComponentFontColor(0);
...
procedure TFrm_SETA1N.FormCreate(Sender: TObject);
Var
  i: Integer;
...
procedure TFrm_SETA1N.proc_init;
var
  i, j: Integer;
  sTemp, sPath: string;
...
procedure TFrm_SETA1N.proc_general;
var
  iVatG : Integer;
  sTmp, sPath: string;
begin
...
procedure TFrm_SETA1N.proc_Accept;
var
  i, j, idx : Integer;
...
begin
  ...
  chkOrderChargeCheck.Checked := GSMyMainTelOrderChargeCheck;
	...
	if GS_KMAiRateName = 'VipFare'     then sTmp := '프리미어' else
	if GS_KMAiRateName = 'EconomyFare' then sTmp := '이코노미' else
...
procedure TFrm_SETA1N.proc_BRList_BubHu;
var
	i, iRow: Integer;
begin
	try
...
procedure TFrm_SETA1N.FormDeactivate(Sender: TObject);
begin
  cxLblActive.Visible := False;
end;

procedure TFrm_SETA1N.FormDestroy(Sender: TObject);
begin
  Frm_SETA1N := Nil;
end;

procedure TFrm_SETA1N.FormShow(Sender: TObject);
Var iTag, i : Integer;
begin
  fSetFont(Frm_SETA1N, GS_FONTNAME);
...
procedure TFrm_SETA1N.imgAModeClick(Sender: TObject);
begin
  rbAMode.Checked := True;
  rbAMode.Font.Style := [fsBold];
  rbBMode.Font.Style := [];
...
procedure TFrm_SETA1N.imgBModeClick(Sender: TObject);
begin
  rbBMode.Checked := True;
  rbBMode.Font.Style := [fsBold];
  rbAMode.Font.Style := [];
...
procedure TFrm_SETA1N.imToolBarMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  ReleaseCapture;
  PostMessage(Self.Handle, WM_SYSCOMMAND, $F012, 0);
...
procedure TFrm_SETA1N.lblNmlTRSType1Step1DblClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.lblNmlTRSType2Step1Click(Sender: TObject);
begin
  ColorDialog1.Color := TcxLabel(Sender).Style.Color;
  if (ColorDialog1.Execute) then
  begin
...
procedure TFrm_SETA1N.lblOrderColor1DblClick(Sender: TObject);
begin
  ColorDialog1.Color := TcxLabel(Sender).Style.Color;
  if (ColorDialog1.Execute) then
  begin
...
procedure TFrm_SETA1N.lb_FastFindDragDrop(Sender, Source: TObject; X,
  Y: Integer);
var
  Num1, Num2: Integer;
...
function TFrm_SETA1N.GetDragSourceListBox(Source: TObject): TcxListBox;
begin
...
procedure TFrm_SETA1N.lb_FastFindDragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  if Source = lb_FastFind then Accept:=True;
end;

procedure TFrm_SETA1N.lb_FastFindMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  NumY := Y;
  NumX := X;
...
procedure TFrm_SETA1N.lb_FastFindOutDragDrop(Sender, Source: TObject; X,
  Y: Integer);
var
  Num1, Num2: Integer;
  Point1, Point2: TPoint;
...
procedure TFrm_SETA1N.lb_FastFindOutDragOver(Sender, Source: TObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
  if Source = lb_FastFindOut then Accept:=True;
end;

procedure TFrm_SETA1N.lb_PayGubun1Click(Sender: TObject);
begin
	ColorDialog1.Color := TPanel(Sender).Color;
	if (ColorDialog1.Execute) then
	begin
...
procedure TFrm_SETA1N.PnlTitleMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
  PostMessage(Self.Handle, WM_SYSCOMMAND, $F012, 0);
...
procedure TFrm_SETA1N.proc_SetBRcolor;
var
  i, iRow: Integer;
begin
  try
...
procedure TFrm_SETA1N.RbButton19Click(Sender: TObject);
Var i : Integer;
begin
...
procedure TFrm_SETA1N.RbButton22Click(Sender: TObject);
var
  sQuery: string;
begin
  Try
...
procedure TFrm_SETA1N.rbChargeType1Click(Sender: TObject);
begin
	GS_ALL_SEVEN := False;
...
procedure TFrm_SETA1N.rbChargeType2Click(Sender: TObject);
begin
	GS_ALL_SEVEN := True;
	pnl_TypeB.visible := GS_ALL_SEVEN;
	GS_All7Type2 := GS_ALL_SEVEN;
...
procedure TFrm_SETA1N.RbCheckBox1Click(Sender: TObject);
begin
  GT_DEFAULT_ST := IfThen(RbCheckBox1.Checked, 1, 0);
  GS_EnvFile.WriteString('CHARGE', 'GT_DEFAULT_ST', IntToStr(GT_DEFAULT_ST));
end;

procedure TFrm_SETA1N.rbchkMainTelRateClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbchk_msg_closeClick(Sender: TObject);
var sTmp : string;
begin
...
procedure TFrm_SETA1N.rbDriverChargeLocalUseYClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.pDriverChargeLocalSetting;
Var i, idx : Integer;
begin
  try
    if GS_JON_DRIVERCHARGELOCAL <> 'n' then
...
procedure TFrm_SETA1N.rbNmlInputPayTypeNoneClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbNmlInputTypeNoneClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbNmlShopCallCenterNClick(Sender: TObject);
begin
  GB_SHOPTYPE_CALLCENTER := TcxRadioButton(Sender).Tag;
  GS_EnvFile.WriteInteger('COUNSEL', 'ShopTypeCheck', GB_SHOPTYPE_CALLCENTER);
end;

procedure TFrm_SETA1N.rbNmlXls2007Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbRoadType1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbRouteType1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rbRSSvr1Click(Sender: TObject);
begin
  GT_DISTANCE_SVR := TcxRadioButton(Sender).Tag;
  GS_EnvFile.WriteString('CHARGE', 'SERVER', IntToStr(GT_DISTANCE_SVR));
end;

procedure TFrm_SETA1N.rbTollType1Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rb_AppOrderClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rb_charge_cal0Click(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rb_NewOrderClick(Sender: TObject);
begin
   if rb_AppOrder.Tag = 99 then exit;
...
procedure TFrm_SETA1N.rb_OnLineServerClick(Sender: TObject);
begin
	Try
...
procedure TFrm_SETA1N.rb_PassTime1Click(Sender: TObject);
begin
  GS_PASSTIMECHK := TcxRadioButton(Sender).Tag;
  GS_EnvFile.WriteString('COUNSEL', 'PASSTIMECHK', IntToStr(GS_PASSTIMECHK));
end;

procedure TFrm_SETA1N.rb_prg_MainClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rb_prg_SubClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rb_TypeBSearchClick(Sender: TObject);
begin
	GS_All7Type2 := True;
	Frm_Main.Menu1220.visible := GS_All7Type2;
...
procedure TFrm_SETA1N.rb_TypeBUseClick(Sender: TObject);
begin
	GS_All7Type2 := False;
	Frm_Main.Menu1220.visible := GS_All7Type2;
	GS_EnvFile.WriteBool('CHARGE', 'CH_TYPE2USE', GS_All7Type2);
...
procedure TFrm_SETA1N.rb_View_DayTimeClick(Sender: TObject);
begin
  GT_MAIN_VIEW_TIME := TcxRadioButton(Sender).Tag;
  GS_EnvFile.WriteString('MAIN_VIEW', 'TIME', IntToStr(GT_MAIN_VIEW_TIME));
end;

procedure TFrm_SETA1N.RDO_OR_COLOR1Click(Sender: TObject);
begin
  if GT_USERIF.LV < '60' then
  begin
    if TcxRadioButton(Sender).Checked then
...
procedure TFrm_SETA1N.RDO_OR_COLOR2Click(Sender: TObject);
begin
  cxGridBRCOLOR.Enabled := True;
  if TcxRadioButton(Sender).Checked then
    GS_JON_BRCOLOR_SET_USE := 0;
...
procedure TFrm_SETA1N.rg_CancelchoiceClick(Sender: TObject);
begin
  gbOrderCancelSelect := rg_Cancelchoice.ItemIndex;
  GS_EnvFile.WriteInteger('Confirm', 'ORDERCANCELSELECT', gbOrderCancelSelect);
end;

procedure TFrm_SETA1N.rg_charge_pcClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.rg_charge_serClick(Sender: TObject);
begin
  Try
...
procedure TFrm_SETA1N.SetAcceptTitle;
var
  i: Integer;
begin
  try
...
procedure TFrm_SETA1N.SetLoadFastFindControls;
Var
  i: Integer;
begin
  for i := 0 to JON03_MAX_CNT - 1 do
...
procedure TFrm_SETA1N.SetOption(iGubun: Integer);
Var
  i: Integer;
begin
  cxPageControl1.ActivePageIndex := 0;
...
procedure TFrm_SETA1N.SetProc_Set_Grid;
Var
  i: Integer;
begin
  for i := 0 to JON03_MAX_CNT - 1 do
...
procedure TFrm_SETA1N.pnl_AcceptDblClick(Sender: TObject);
begin
...
procedure TFrm_SETA1N.proc_MySQLTOLocalDATA;
var
...
procedure TFrm_SETA1N.CheckTRSPenaltyChange(AType: Integer;
  ATypeRec: TTRSPenaltyTypeRec);
label
  SetEnabledFlow;
var
...
procedure TFrm_SETA1N.GetValueTRSPenalty(AType: Integer;
  var ATypeRec: TTRSPenaltyTypeRec);
begin
  case AType of
    1:
...
procedure TFrm_SETA1N.SetValueTRSPenalty(AType: Integer;
  ATypeRec: TTRSPenaltyTypeRec);
begin
  case AType of
    1:
...
procedure TFrm_SETA1N.proc_Sync_DataTime_Set;
var
  sQuery, sDate: string;
begin
  try
...
procedure TFrm_SETA1N.proSetSET06Item;
begin
...
procedure TFrm_SETA1N.pSetMakeSearchMenu;
Var i, ii, j : integer;
		sG : String;
begin
...
procedure TFrm_SETA1N.rbAutoUpsoYClick(Sender: TObject);
begin
	GBJON01_AUTO_UPSO_YN := rbAutoUpsoY.Checked;
	GS_EnvFile.WriteBool('COUNSEL', 'JON01_AUTO_UPSO_YN', GBJON01_AUTO_UPSO_YN);
end;

procedure TFrm_SETA1N.pSetComponentFontColor(iTag : Integer; sWord : String );
Var j, ii : Integer;
begin
...
procedure TFrm_SETA1N.SetFontFaceList;
