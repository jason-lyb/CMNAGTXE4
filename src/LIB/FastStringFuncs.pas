...
function CopyStr(const aSourceString : AnsiString; aStart, aLength : Integer) : AnsiString;
function Decrypt_Fast(const S: AnsiString; Key: Word): AnsiString;
function Encrypt_Fast(const S: string; Key: Word): string;
...
function RightStr(const aSourceString : AnsiString; Size : Integer) : AnsiString;
...
const
  cKey1 = 52845;
  cKey2 = 22719;
  Base64_Table : AnsiString = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';
